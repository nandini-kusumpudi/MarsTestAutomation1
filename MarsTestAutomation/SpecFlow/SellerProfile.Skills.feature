...
#	profile skills add
    ...
    Scenario: Add Profile skills with data
        ...
        And I enter the data in '<SkillName>' and '<SkillLevel>'  and click on Add button
    ...
    Scenario: Add Profile Skills without data
        ...
        When I click on skills tab
        And I click on Add New button
        And I click on Add button  without data in Skills and Skills level field
    ...
    Scenario: Add Profile Skills with only Add skills
        ...
        When I click on skills tab
        And I click on Add New button
        And I Enter data in Skills and click on Add button
        Then a popup should be shown with this message (Please entry Skills and Experience level)
    ...
    Scenario: Add Profile Skills with only Skill level
        ...
        When I click on skills tab
        And I click on Add New button
        And I Select Skill level and click on Add button
        Then a popup should be shown with this message (Please entry Skills and Experience level)
    ...
    Scenario: Add Profile Skills with Specal characters
        ...
        When I click on skills tab
        And I click on Add New button
        And I Enter Specal characters in Skills and select Skill level and click on Add button
    ...
    Scenario: Edit Profile Skills with data
        ...
        And I Edit the data in '<SkillName>' and '<SkillLevel>'  and click on update button
        Then A popup '<Message>' should be shown
    ...
    Scenario: Edit Profile Skills without data
        ...
        When I click on skills tab
        And I click on Skill Edit pen icon
        And I click on update button without data
    ...
    Scenario: Edit Profile Skills without Edited
        ...
        When I click on skills tab
        And I click on Skill Edit pen icon
        And  I click on update button without edited
    ...
    Scenario: Edit Profile Skills with only language
        ...
        And I Edited the Skills click on update button
    ...
    Scenario: Edit Profile Skills with only language level
        ...
        When I click on skills tab
        And I click on pen icon
        And I edited Skills level and click on update button
